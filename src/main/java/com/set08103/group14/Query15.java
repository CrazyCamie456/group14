...
public class Query15 {
    public static void run() {
        ...
        do{
            ...
            String query = "SELECT TOP"+resultNumber+" Name, Population, District, (SELECT Name FROM country WHERE Code = CountryCode) FROM cities WHERE CountryCode = (SELECT Code FROM country WHERE Name =  " + countryName + ");";
